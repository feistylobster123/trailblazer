      ...
      <AppShell>
        <Suspense fallback={<LoadingFallback />}>
          <Routes>
            ...
            <Route path="/races/:raceId/register" element={<RegistrationPage />} />
            <Route path="/races/:raceId/results/:year" element={<ResultsPage />} />
            <Route path="/races/:raceId/live" element={<LiveTrackingPage />} />
            <Route path="/races/:raceId/stream" element={<LiveStreamPage />} />
            <Route path="/runners/:runnerId" element={<RunnerProfilePage />} />
            <Route path="/crew/:raceId" element={<CrewPortalPage />} />
